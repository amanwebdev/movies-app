...
export class ObjectStore {
  ...
  createStores(db: IDBDatabase) {
    ...
    // Creates "TodoStore".
    var movieStore: IDBObjectStore = db.createObjectStore("MovieStore", { keyPath: 'id', autoIncrement: true });
    //var titleIndex: IDBIndex = movieStore.createIndex("movie_title", "movie_title", { unique: false });
